    ...
    <div className="space-y-6">
      <section className="rounded-2xl border border-slate-200 bg-white p-8 shadow-panel dark:border-slate-800 dark:bg-slate-900">
        ...
        <p className="mt-4 max-w-3xl text-sm text-slate-600 dark:text-slate-300 sm:text-base">
          This portfolio is built as a case-study hub for React + TypeScript
          and Python development with heavy domain logic. The intent is to show
          not only UI outcomes but also algorithmic reasoning and testing
          discipline.
        </p>
      </section>
